...
import '../../styles/TestEnvTeam/TestEnvTeamCollapse.scss';
  ...
  return (
    <div className="DefinedCollapseContainer">
      ...
      <Form form={form} component={false}>
        <Collapse defaultActiveKey={['1']} onChange={callback} bordered={false} expandIconPosition={'right'}>
...
export default TestEnvTeamCollapse;
