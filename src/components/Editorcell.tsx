...
import { Button, Form, Input, InputNumber, Menu, message, Popconfirm, Popover, Table } from 'antd';
...
const choiceAction = ({ editingKey, edit, record, delRow }) => {
  ...
  return (
    <Menu>
      <Menu.Item>
        <span className="EditDelRowCla" onClick={(e) => edit(e, record)}>
          1st tem编辑6
        </span>
      </Menu.Item>
      <Menu.Item>
...
const EditableCellComp = () => {
  const originData: any = [
    ...
    },
    {
      ...
      targetMean: '加强专业化测试与质控能力内建，为项目实施提供专业保障，通过技术工具推广赋能事业群质量内建',
    },
  ];
...
export default EditableCellComp;
