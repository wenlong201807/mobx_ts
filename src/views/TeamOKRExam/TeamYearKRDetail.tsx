...
import '../../styles/TeamOKRExam/TeamYearKRDetail.scss';
            ...
            <div className="yearRelative">
                <div className="title">
                    <div className="subtitle_55">
                        <span className="subtitle_third">年度KR21：</span>
                        测试环境绿灯雷达监测开发工作
                    </div>
            ...
            */} </div>
            ...
            <div className="personTeamYearKRConnectClaWrap">
                ...
                <div className={
                    ...
                    {/* 每一个季度的KR  ***可展开收起的部分 **通过添加，删除样式控制 className={{'reasonContentShow':true reasonContentHide:false}}*/}
                    <div className={
                        classnames({reasonContentConnectShow: true, reasonContentHide: isExpandKR})
                    }>
                        {/* 每一个KR*/}
                        <div className="KRContentWrap">
                            {/* 循环起点***起点 */}
                            ...
                            <div className="PersonYearKRTitle">
                                <div className="KR"
                                    onClick={openTeamReasonDetail}>
                                    <div>
                                        <span className="innerTitle">个人年度KR1:</span>
                                        根据智慧协同品平台的实际要求，按时完成测试环境可视化的各项工作
                                    </div>
                                </div>
                            ...
                            <div className="PersonYearKRTitle">
                                <div className="KR"
                                    onClick={openTeamReasonDetail}>
                                    <div>
                                        <span className="innerTitle">个人年度KR2:</span>
                                        根据智慧协同品平台的实际要求，按时完成测试环境可视化的各项工作
                                    </div>
                                </div>
                                <div className="small_15">&nbsp;</div>
