...
import '../../styles/TeamOKRExam/PanoramicView.scss';
        ...
        <div className="PanoramicViewClaWrap">
            ...
            <div className="teamListClaWrap">
                ...
                <div className="optionGroupBtn">
                    ...
                    <Select defaultValue="lucy4"
                        onChange={exameSelChange}
                        style={
                            {
                                width: 120,
                                marginRight: 10
            ...
            <div className="tableHead">
                ...
                <div className="grayHead sortWrap">
                    <span>考核得分</span>
                    <span className="sortUpDwon">
                        <span className="sortUp"
                            onClick={
                                () => sortHandle(true)
                        }></span>
                        <span className="sortDwon"
                            onClick={
                                () => sortHandle(false)
                        }></span>
                    </span>
            ...
            <div className="tableContentWrap">
                <div className="tableContent">
                    ...
                    <div className="tableAction">
                        <span className="btnAction"
                            onClick={
                                () => jumpToExameDetail('exame')
                        }>
                            考核
                        </span>
                        <span className="btnAction"
                            onClick={
                                () => jumpToExameDetail('detail')
                        }>
                            详情
                        </span>
                    </div>
